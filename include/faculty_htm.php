                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-8 text">
                            <h1><strong>Financial Grant Management System<br><br>Faculty Home</strong></h1>
                        </div>
            <?php
                            ...
                            <div class="form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        ...
                                        <p>Request to view your fellow's grants:</p>
                                    </div>
                                </div>
                                <div class="form-bottom">
                                    <form role="form" action="http://localhost/SE/include/Req_Access.php" method="post" class="login-form">
                                        <button type="submit" class="btn"><b>Request Access Permission</b></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-box">
                                <div class="form-top">
                                    <div class="form-top-left">
                                        ...
                                        <p>Access the grants log of your fellows :</p>
                                    </div>
                                </div>
                                <div class="form-bottom">
                                    <form role="form" action="http://localhost/SE/include/Access_Grants.php" method="post" class="login-form">
